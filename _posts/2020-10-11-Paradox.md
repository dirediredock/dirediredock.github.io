...
Below is the shoreline of Burrard Inlet color-coded so that points closer to the start (Point Atkinson) are darker purple and points closer to the end (Point Gray) are bright yellow.
