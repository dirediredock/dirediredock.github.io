...
Many thanks to fellow PhD researcher Greig Olford who georectified an old 1892 Admiraly map of Burrard Inlet using ArcGIS, which formed the basis for the vectorized shoreline data in the `.csv` files shown above. 
