...
Many thanks to fellow PhD researcher Greig Olford who georectified the 1890 map using ArcGIS, which formed the basis for the vectorized shoreline data in the `.csv` files shown above. 
